                                ...
                                <div class="profile-info-widget">
                                    ...
                                    <div class="profile-det-info">
                                        ...
                                        <div class="patient-details">
                                            <h5><i class="fa fa-mars"></i><?php echo $row['patient_age']; ?>,
                                                <?php echo $row['patient_gender']; ?></h5>
                                            <h5 class="mb-0"><i
                                                    class="fas fa-map-marker-alt"></i><?php echo $row['patient_address']; ?>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="pat_invoices" class="tab-pane fade">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <a href="pat-invoice-view.php"><?php echo $row['invoice_id'];?></a>
                                            </td>
                                            ...
                                            <?php
                                                ...
                                                $sql2 = mysqli_query($conn,"select * from doctor_tbl where id = $row[doctor_id] ");
                                                ...
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html"
                                                        ...
                                                        <img class="avatar-img rounded-circle"
                                                            src="assets/img/doctors/<?php echo $row2["doctor_image_name"]; ?>.jpg" width="20" alt="User Image">
                                                    </a>
                                                    <a
                                                        href="doctor-profile.html"><?php echo $row2['doctor_name'];?><span><?php echo $row2['id'];?></span></a>
                                                </h2>
